            ...
            <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
                <div>
                    <p class="small text-muted">
                        @lang('pagination.info', ['start' => '<span class="fw-semibold">'.$paginator->firstItem().'</span>', 'end' => '<span class="fw-semibold">'.$paginator->lastItem().'</span>', 'total' => '<span class="fw-semibold">'.$paginator->total().'</span>'])
                    </p>
                </div>
